...
namespace CityInfo.API.Services
{
    ...
    public class CityInfoRepository : ICityInfoRepository
    {
        ...
        {
            var cityCollection = _context.Cities as IQueryable<City>;
            ...
            if (!string.IsNullOrWhiteSpace(searchQuery))
            {
                ...
                cityCollection = cityCollection.Where(a => a.Name.Contains(searchQuery) 
            ...
            var collectionToReturn = await cityCollection.OrderBy(c => c.Name == name)
